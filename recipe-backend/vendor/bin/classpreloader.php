 ...
 *
 * This file includes the referenced bin path (../classpreloader/classpreloader/classpreloader.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../classpreloader/classpreloader/classpreloader.php';
